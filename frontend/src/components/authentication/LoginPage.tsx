...
const Button = styled.button.attrs((props: {c: string, wid: string, bc: string}) => props)`
...
const FlexContainer = styled.div.attrs((props: {mb: string, pad: string, ta: string}) => props)`
  flex: 100%;
  width: 347px;
        ...
        <FlexContainer mb='-20px'>
            <Form>
                <Flex dir='column' ai='center'>
                    ...
                    <FlexContainer>
                        <Flex dir='row'>
                          <Button wid='176.67px' c='#5F8F3E'> Create Account </Button>
                          <Button type="submit" wid='149.61px' bc='#5F8F3E' c='#ffffff' onClick={retrieveUser}> Sign in </Button>
                        </Flex>
                    </FlexContainer>
                </Flex>
            </Form>
